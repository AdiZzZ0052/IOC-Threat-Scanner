...
### Changed
- App window title now displays version number: `IOC-Threat-Scanner-v1.0.7`
- EXE output name updated to `IOC-Threat-Scanner-v1.0.7`

### Fixed
- Removed unused `global CONFIG` statement in `load_config()` that caused CI Code Quality check to fail (flake8 F824)
